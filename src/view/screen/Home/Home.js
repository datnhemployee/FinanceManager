...
export default class extends Component {
    constructor (props) {
        ...
        this.navigateToDetailSpense = this.navigateToDetailSpense.bind(this);
    }
    ...
    navigateToDetailSpense(id) {
        this.setState({
            navigation: Navigation.detailSpense,
            detailedSpenseId: id,
        })
    }
    ...
    change () {
        ...
        return (
            <Text 
                ...
                // this.state.wallet >= 0?{color:Color.DarkGreen}:{color:Color.Red}
                ]}>
                {/* {params.changeTitle} */}
                {Typeface.toCase({
    ...
    get detailSpense () {
        return (
        <DetailSpense 
            visible= {this.state.navigation === Navigation.detailSpense}
            id = {this.state.detailedSpenseId}
            backButtonOnClick = {this.onCardClick}
    ...
    detail () {
        ...
        return (
            <Detail
                ...
                navigateToDetailSpense = {this.navigateToDetailSpense}
            />
        )
    }
