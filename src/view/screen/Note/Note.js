...
export default class extends Component {
    ...
    _onChangePrice (text) {
        this.state.spense.price = !!text?text:0;
        this.setState({spense: this.state.spense});
    }
    ...
    async saveButtonClick () {
        ...
        let isAvailable_name = !!this.state.spense.name;
        let isAvailable_price = !!this.state.spense.price;
    ...
    datePicker () {
        ...
        return (
            <TouchableOpacity
                ...
                style= {substyles.body.mid.datePicker}>
                <Text style= {substyles.body.mid.datePickerText}>
                    NGÀY {dayPick} THÁNG {monthPick + 1} NĂM {yearPick}</Text>
            </TouchableOpacity> 
        )
    }
