...
import Footer from '../../component/Expenditure/Footer/Expenditure.Footer'
import Body from '../../component/Expenditure/Body/Expenditure.Body'
import Name from './Expenditure.design.interface';
import styles from './Expenditure.style';
import {Index} from '../../../constant/Navigation.type';

const props = {
    name: Index.expenditure,
}
/**
